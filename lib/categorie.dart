  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(leading: GestureDetector(
          onTap:(){Navigator.of(context).pop();},child: Icon(Icons.arrow_back_ios_new_rounded,color: Color(0xFF477B72),)),
        title:
        Center(
    ...
    ExpandedTileList.builder(
      ...
      itemBuilder: (context, index, con) {
        return ExpandedTile(
          ...
          controller: con,
          title: Text("Bussiness  $index"),
          content: SizedBox(width: 500.w,height: 250.h,
           child: ListView.separated(
             itemCount: 20,scrollDirection: Axis.horizontal,
             itemBuilder: (context, position) {
               return GestureDetector(onTap: (){ Navigator.of(context).push(MaterialPageRoute(builder: (_)=>Video())); },
                 child: Container(
